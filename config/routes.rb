GankaoSeason3::Application.routes.draw do
  ...
  resources :learn do
    collection do
      ...
      post :task_dispatch,:jude_word, :jude_sentence, :jude_hearing, :jude_read,:check_similar
      post  :i_have_remember,:jude_translate,:jude_translate_one,:jude_listen,:jude_write
    end
  end
